                    ...
                    <td className="p-2 text-center">
                      <div className="flex gap-2 justify-center">
                        ...
                        <button 
                          ...
                          className="text-sm text-red-600 hover:underline disabled:text-gray-400 disabled:cursor-not-allowed disabled:no-underline"
                          disabled={hasMatches}
                          title={hasMatches ? 'Cannot remove athletes after draw is generated' : ''}
                        >
                          Remove
                        </button>
                      </div>
